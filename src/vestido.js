...
function Vestido({ products }) {
  const vestidoProducts = products.filter(product => product.className.startsWith('vestido'));
  ...
  return (
    <>
      ...
      <div>
        <h1 className="vestidos">Vestidos:</h1>
        <div >
          {vestidoProducts.map((product, index) => (
